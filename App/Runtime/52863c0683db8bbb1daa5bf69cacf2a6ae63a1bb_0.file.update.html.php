<?php
/* Smarty version 3.1.30, created on 2017-03-04 17:03:00
  from "D:\WAMP\WWW\blog\App\Admin\View\Category\update.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58ba82c4b89590_64706267',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '52863c0683db8bbb1daa5bf69cacf2a6ae63a1bb' => 
    array (
...
function content_58ba82c4b89590_64706267 (Smarty_Internal_Template $_smarty_tpl) {
?>
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="?c=Category&a=updateHandle" method="post" id="myform" >
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>分类名称：</th>
                                <td>
                                    <input value='<?php echo $_smarty_tpl->tpl_vars['row']->value['name'];?>
' class="common-text required" id="name" name="name" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>所属分类：</th>
...
?>
                        ...
                        <option <?php if ($_smarty_tpl->tpl_vars['val']->value['categoryid'] == $_smarty_tpl->tpl_vars['row']->value['pid']) {?>selected="selected"<?php }?>
                        style="padding-left: <?php echo $_smarty_tpl->tpl_vars['val']->value['lev']*10;?>
...
?>
                            ...
                            <tr>
                                <th>
                                    <input type="hidden" value=<?php echo $_smarty_tpl->tpl_vars['row']->value['categoryid'];?>
 name="id"/>
                                </th>
                                <td>
